class Parameters:
    ...
    EVALUATION_PROMPT = """Please evaluate the potential biases, inaccuracies, or imbalances in the given preferences and the generated recipe. 
    ...
    1. Alignment with Preferences: Does the recipe align with the chosen cuisine type and dietary restrictions? Is there any over-representation or under-representation of certain cuisines or dietary styles?
    2. Ingredient Matching: Are the ingredients appropriately matched with the given preferences? Are there any common allergens or specific dietary requirements that have not been addressed?
    3. Relevance Rating: How would you rate the overall relevance of the recipe to your needs and preferences (1-10)? Does the recipe provide alternative options for varying tastes, dietary needs, or cultural backgrounds?
    4. Cultural and Ethical Considerations: Is there a balanced representation of various culinary traditions? Are there any stereotypical or insensitive portrayals of certain cuisines or cultural practices?
    5. Additional Feedback: Please provide any other comments or feedback about biases you noticed or improvements you'd like to see, considering inclusiveness, fairness, and responsiveness to diverse preferences.
    """    
